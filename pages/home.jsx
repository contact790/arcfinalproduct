    ...
    <div className="page-enter">
      ...
      <section style={{padding:"48px 0", borderTop:"1px solid var(--hairline)", borderBottom:"1px solid var(--hairline)"}}>
        <div className="wrap">
          ...
          <div style={{display:"flex", justifyContent:"center", alignItems:"center", flexWrap:"wrap", gap:72}}>
            {[
      ...
      <section style={{padding:"80px 0 100px", borderTop:"1px solid var(--hairline-strong)"}}>
        <div className="wrap">
          ...
          <window.StaggerReveal baseDelay={0.05} stagger={0.12} style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:24}}>
            {/* Web card */}
