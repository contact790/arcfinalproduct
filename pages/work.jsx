  ...
  return (
    <div className="page-enter">
      ...
      <section className="page-hero">
        <div className="wrap">
          <div style={{display:"grid", gridTemplateColumns:"1.4fr 1fr", gap:64, alignItems:"end", position:"relative", zIndex:1}}>
            <div>
      ...
      <section style={{padding:"64px 0 40px"}}>
        <div className="wrap">
          ...
          <window.StaggerReveal style={{display:"grid", gridTemplateColumns:"repeat(3, minmax(0, 1fr))", gap:24}} baseDelay={0.1} stagger={0.12}>
            {[1,2,3].map((n) => (
