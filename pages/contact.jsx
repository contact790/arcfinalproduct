  ...
  return (
    <div className="page-enter">
      ...
      <section className="page-hero">
        <div className="wrap">
          <div style={{display:"grid", gridTemplateColumns:"1.5fr 1fr", gap:64, alignItems:"end", position:"relative", zIndex:1}}>
            <div>
      ...
      <section style={{padding:"80px 0 80px"}}>
        <div className="wrap" style={{display:"grid", gridTemplateColumns:"repeat(2, minmax(0, 1fr))", gap:64, alignItems:"start"}}>
